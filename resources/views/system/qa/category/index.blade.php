	            ...
	            <td class="text_title">
	                <div class="title_btn_area">
	                    <div class="title_edit_btn">
	                        <a href="{{ route('qa.category.edit',$category->id)}}">編集</a>
						</div>
						<form action="{{ route('qa.category.delete',$category->id)}}" id="qa-delete-{{ $category->id}}" method="post">
							{{ csrf_field( )}}
							{{ method_field('DELETE') }}
						</form>
